...
c=int(input("Cart Value ="))
u=(input("User Type=")).lower()
...
if a>b:
    if a>c:
        if a>d:
            if a>e:
                if a>f:
                    print("Higest Stock =",a)
                else:
                    print("Higest Stock =",f)
            else:
                if e>f:
                    print("Higest stock =",e)
                else:
                    print("Higest Stock =",f)
        else:
            if d>e:
                if d>f:
                    print("Higest Stock =",d)
                else:
